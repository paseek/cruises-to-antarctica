...
/* harmony import */ var _modules_map_map__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/map/map */ "./js/modules/map/map.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  burger.init();
  Object(_modules_map_map__WEBPACK_IMPORTED_MODULE_2__["initMap"])({
    id: 'map',
    initials: {
...
var initMap = function initMap(mapData) {
  ...
  var mapElement = document.getElementById(mapData.id);
  if (!mapElement) {
    return;
  }
  if (apiLoaded) {
